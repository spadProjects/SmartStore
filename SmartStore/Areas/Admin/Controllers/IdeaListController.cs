...
namespace SmartStore.Areas.Admin.Controllers
{
    public class IdeaListController : Controller
    {
        ...
        public ActionResult Index(int? Page, int? pageSize)
        {
            ...
            List<SmartStore.Model.Entities.Idea> idealist = new List<Idea>();
            idealist = db.Ideas.ToList();
            return View(idealist.ToPagedList(PageNumber, pagesize));
        }

        public ActionResult IdeaListDetails(int? id)
        {
            if (id == null)
            {
